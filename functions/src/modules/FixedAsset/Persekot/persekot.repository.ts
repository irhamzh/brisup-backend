...
import { IPersekotBase } from '@modules/FixedAsset/Persekot/interface/persekot.interface';
import { db } from '@utils/admin';
import * as admin from 'firebase-admin';

export default class PersekotRepository extends BaseRepository<IPersekotBase> {
